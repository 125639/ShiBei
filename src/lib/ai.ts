...
export function sourceBoundaryRules() {
  return [
    ...
    "- 事实核验：涉及具体人物表态、公司动作、政策时间线、数字结论等可查证细节时，必须优先寻找多条来源相互印证；资料互相冲突或不足以确认时，集中写入「待确认/争议点」，不要把它写成已证实结论。",
    "- 不复制粘贴原文长段落，要用自己的语言重组。",
    "- 如果来源材料本身只是 401/403/404、访问受限、验证码、错误页或空页面，而不是正文材料，必须只输出 INVALID_SOURCE，不得写成文章。",
