...
export const FONTS: Array<{
...
}> = [
  {
    ...
    preview: "新闻总结",
    family: "ui-serif, 'Source Han Serif SC', 'Noto Serif CJK SC', 'Songti SC', Georgia, serif"
  },
  {
    key: "sans-cjk",
    label: "中文无衬线",
    ...
    preview: "新闻总结",
    family: "ui-sans-serif, 'PingFang SC', 'Source Han Sans SC', 'Noto Sans CJK SC', sans-serif"
  },
  {
    key: "kaiti",
    label: "霞鹜文楷",
    ...
    preview: "新闻总结",
    family: "'LXGW WenKai', 'KaiTi', 'STKaiti', 'Source Han Serif SC', serif"
  },
  {
    key: "fangsong",
    label: "仿宋",
    desc: "正式典雅，适合公文与长文",
    preview: "新闻总结",
    family: "'FangSong', 'STFangsong', 'Source Han Serif SC', serif"
  },
  {
    key: "system",
    label: "系统默认",
  ...
  },
  {
    ...
    preview: "新闻总结",
    family: "ui-monospace, 'JetBrains Mono', 'Source Han Mono SC', monospace"
  }
];
